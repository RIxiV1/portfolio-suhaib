...
export function BackgroundPaths({ title = "Shaik Mohammed Suhaib" }: { title?: string }) {
      ...
      <div className="relative z-10 container mx-auto px-4 md:px-6 text-center">
        ...
        >
          ...
          <motion.p
            ...
            className="text-xl md:text-2xl text-slate-600 dark:text-slate-400 mb-4 font-medium"
          >
          ...
          <motion.p
            ...
            className="text-base md:text-lg text-slate-500 dark:text-slate-500 mb-10 max-w-xl mx-auto"
          >
          ...
          >
            <a href="#projects">
              <InteractiveHoverButton text="View My Work" />
            </a>
          </motion.div>
        </motion.div>
      </div>
